...
- 隔日掛單計畫 / Next-Day Order Planner：把策略級買進 / 賣出 / 停損參考價轉成更接近隔日可成交波動範圍的買賣區、戰術停損、硬停損與觸及機率標籤；只做研究輔助，不自動下單
...
9. 打開「隔日掛單計畫」查看隔日買進 / 賣出區、戰術停損、硬停損，以及這些價位是否有機會被正常日內波動觸及。
...
- order_planner.py：隔日掛單研究規劃器；從持倉、OHLCV 波動與決策報表估算隔日買賣區、戰術停損、硬停損、觸及機率與建議單型
